...
import 'RegisterMatriculaPage.dart';
    ...
    return Scaffold(
      ...
      body: BlocListener<MatriculaBloc, MatriculaState>(
        listener: (context, state) {
          if (state is MatriculaDeletedSuccess || state is MatriculaUpdatedSuccess) {
            context.read<MatriculaBloc>().add(FetchMatriculasEvent());
          }
        },
                          ...
                          Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  bool? result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => RegisterMatriculaPage(matricula: matricula),
                                    ),
                                  );
                                  if (result == true) {
                                    context.read<MatriculaBloc>().add(FetchMatriculasEvent());
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  context.read<MatriculaBloc>().add(DeleteMatriculaEvent(matricula.idMatricula!));
                                },
                              ),
                            ],
                          ),
